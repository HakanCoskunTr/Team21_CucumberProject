...
public class JdbcUtils {
    ...
    public static Connection connectToDatabase(String hostName, String dbName, String username, String password) {
        ...
        String result = connection != null ? "Connection Success" : "Connection Fail";
    ...
    public static void closeConnectionAndStatement() {
        ...
        try {
            String result1 = connection.isClosed() ? "Connection Close" : "Connection Close Fail";
            String result2 = statement.isClosed() ? "Statement Close" : "Statement Close Fail";
    ...
    // Insert Into - Tablo ya data girme
